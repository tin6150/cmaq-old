...
C***********************************************************************
C Version "$Id: projtool.f 123 2015-01-22 15:39:57Z coats $"
...
C       Version 01/2015 by CJC:  spheroid-managemeent bug found by John McHenry.
C       Version 01/2015 by CJC:  Bug reproted by Bhupesh Adhikary,
C       International Centre for Integrated Mountain Development
C       Kathmandu, Khumaltar, Lalitpur, Nepal
C***********************************************************************
...
C...........   LOCAL VARIABLES and their descriptions:
        ...
        REAL*8          U01, V01, U10, V10, U11, V11
        REAL*8          XSW, YSW, XSE, YSE, XNW, YNW, XNE, YNE
        REAL*8          USW, VSW, USE, VSE, UNW, VNW, UNE, VNE
        REAL*8          XX, YY
        INTEGER         CC, RR
        CHARACTER*256   MESG
        LOGICAL         EFLAG
...
C.......   Arguments for GTPZ0:
        ...
        LOGICAL :: INSET   = .FALSE.
        LOGICAL :: OUTSET  = .FALSE.
        LOGICAL :: INGRID  = .FALSE.
        LOGICAL :: OUTGRID = .FALSE.
...
C   begin body of program PROJTOOL
     ...
     &' ',
     &'Program version: ',
     &'$Id:: projtool.f 123 2015-01-22 15:39:57Z coats               $',
     &' '
...
111     CONTINUE        !  head of event loop
     ...
     &                  UNE, ',', VNE, ')'
            ...
            ELSE IF ( MODE .EQ. 11 ) THEN       ! compute corner-cell centers
                ...
                XNW = X00
                YNW = Y00 + DBLE( NROWS1 - 1 )*YCELL1
                XSE = X00 + DBLE( NCOLS1 - 1 )*XCELL1
                YSE = Y00
                XNE = X00 + DBLE( NCOLS1 - 1 )*XCELL1
                YNE = Y00 + DBLE( NROWS1 - 1 )*YCELL1
