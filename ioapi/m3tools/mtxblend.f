...
C...........   PARAMETERS and their descriptions:
        ...
        DATA PROGVER /
     &'$Id:: mtxblend.f 49 2007-07-06 16:20:50Z coats@borel          $'
     &  /
     ...
     &                       'SYNCH_FILE', 'MTXBLEND' )
        ...
        IF ( SFLAG ) THEN
            ...
            IF ( .NOT. DESC3( SNAME ) ) THEN
                ...
                CALL M3EXIT( 'MTXBLEND', 0, 0, MESG, 2 )
            END IF
...
C...............  Open and get description for input data file 2
        ...
        GNAME = PROMPTMFILE( MESG, FSREAD3,
     &                       'BASE_DATA', 'MTXBLEND' )
...
C...............  Open output file
        ...
        ONAME = PROMPTMFILE( MESG, FSUNKN3, 'OUT_DATA', 'MTXBLEND' )
