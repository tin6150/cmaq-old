...
C***********************************************************************
C Version "$Id: xtract3.f 245 2015-10-26 12:30:56Z coats $"
...
C
C       Modified 10/2015 by CJC:  Correction in error-message at line 221
C***********************************************************************
...
C.......   Perform range checks on variable, layer, row, col:
     ...
     &          'Upper bound:            ', COL1
            CALL M3MSG2( MESG )
            WRITE( MESG, '( A, I9 )' ) 
     &          'Actual number of cols:', NCOLS3( FID )
            CALL M3MSG2( MESG )
